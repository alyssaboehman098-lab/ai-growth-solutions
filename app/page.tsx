      ...
      <nav className="sticky top-0 z-20 border-b border-slate-800/80 bg-slate-950/85 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4 sm:px-6">
          <a href="#top" className="flex items-center gap-3 text-xl font-bold text-white">
            <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-orange-400 to-blue-600 text-sm font-black text-slate-950">
              A
            </span>
      ...
      <section id="top" className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16 lg:py-20">
        <div className="grid items-center gap-10 lg:grid-cols-[1.2fr_0.8fr]">
          <div className="text-center lg:text-left">
            <div className="mb-6 inline-flex rounded-full border border-orange-500/40 bg-orange-500/10 px-4 py-2 text-sm font-medium text-orange-300">
  ...
  revenue.
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:justify-center lg:justify-start">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="rounded-xl bg-orange-500 px-7 py-4 text-base font-semibold text-white shadow-lg shadow-orange-500/20 transition hover:bg-orange-600"
              >
                Get My Free Audit
              </a>
              <a
          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900/80 p-5 shadow-2xl shadow-orange-950/40 sm:p-6">
            <div className="mb-5 flex items-center justify-between">
              <p className="text-sm uppercase tracking-[0.2em] text-orange-300">Business Snapshot</p>
            ...
            <div className="space-y-4">
              <div className="rounded-2xl bg-slate-950 p-4">
                ...
                <p className="mt-2 text-3xl font-black text-orange-400">Instant</p>
              </div>
              ...
              <div className="space-y-3 rounded-2xl bg-slate-950 p-4">
                ...
                <div className="h-2 rounded-full bg-slate-800">
                  <div className="h-2 w-[94%] rounded-full bg-orange-500" />
                </div>
                ...
                <div className="h-2 rounded-full bg-slate-800">
                  <div className="h-2 w-[85%] rounded-full bg-orange-500" />
                </div>
              </div>

              <div className="rounded-2xl border border-orange-500/20 bg-orange-500/5 p-4 text-sm text-slate-200">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mb-10 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-orange-300">Why choose us</p>
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          {testimonials.map((testimonial) => (
            <div key={testimonial.name} className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
              <div className="mb-5 flex gap-1 text-orange-400">
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mb-10 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-orange-300">Process</p>
        ...
        <div className="grid gap-6 md:grid-cols-3">
          {steps.map((step) => (
            <div key={step.title} className="rounded-3xl border border-slate-800 bg-slate-900 p-6">
              <h3 className="mb-3 text-2xl font-bold text-orange-400">{step.title}</h3>
      ...
      <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="mb-10 text-center">
          <p className="mb-3 text-sm font-semibold uppercase tracking-[0.2em] text-orange-300">How to get started</p>
          ...
          {pricing.map((plan) => (
            ...
            >
              <div className="mb-4 flex items-center justify-between">
                ...
                {plan.highlighted ? (
                  <span className="rounded-full bg-orange-500 px-2.5 py-1 text-xs font-semibold text-slate-950">
                    Most Popular
                  </span>
                ) : null}
              </div>
      ...
      <section id="contact" className="mx-auto max-w-6xl px-4 py-12 sm:px-6 sm:py-16">
        <div className="rounded-[2rem] border border-orange-500/20 bg-gradient-to-br from-slate-900 via-slate-900 to-orange-950/30 p-6 sm:p-8 lg:p-10">
            ...
            <div className="rounded-3xl border border-slate-700 bg-slate-950/60 p-6">
              <div className="space-y-4 text-sm text-slate-300">
                ...
                <div>
                  ...
                  <a href="mailto:alyssaboehman098@gmail.com" className="mt-1 inline-block text-base text-orange-300 hover:text-orange-200">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="mt-6 inline-flex w-full justify-center rounded-xl bg-orange-500 px-5 py-3.5 font-semibold text-white transition hover:bg-orange-600"
              >
      ...
      <section className="bg-slate-900 px-4 py-16 text-center sm:px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-xl bg-orange-500 px-8 py-4 text-base font-bold text-white transition hover:bg-orange-600"
          >
            Get My Free Audit
          </a>
        </div>
      ...
      <div className="fixed inset-x-0 bottom-0 z-30 border-t border-slate-700 bg-slate-950/95 p-3 shadow-[0_-10px_30px_rgba(0,0,0,0.4)] backdrop-blur-md sm:hidden">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex w-full items-center justify-center rounded-xl bg-orange-500 px-5 py-3 text-base font-bold text-white"
        >
          Get My Free Audit
        </a>
      </div>
      ...
      <footer className="border-t border-slate-800 py-10 text-center">
        <h3 className="mb-2 text-xl font-bold text-orange-400">Alyssa AI Solutions</h3>
        <p className="text-slate-400">Owensboro, Kentucky</p>
        <a href="mailto:alyssaboehman098@gmail.com" className="mt-2 inline-block text-slate-400 transition hover:text-orange-300">
          alyssaboehman098@gmail.com
        </a>
      </footer>
    </main>
